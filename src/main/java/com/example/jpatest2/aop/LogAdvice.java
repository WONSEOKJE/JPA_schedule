package com.example.jpatest2.aop;
...
public class LogAdvice {
    ...
    @Around("execution(* com.example.jpatest2.controller..*Controller.*(..))"
            +" || execution(* com.example.jpatest2.service..*Service*.*(..))"
            +" || execution(* com.example.jpatest2.repository..*Repository.*(..))")
